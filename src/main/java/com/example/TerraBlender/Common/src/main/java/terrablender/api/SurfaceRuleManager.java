...
import com.example.TerraBlender.Common.src.main.java.terrablender.worldgen.TBSurfaceRuleData;
import com.example.TerraBlender.Common.src.main.java.terrablender.worldgen.surface.NamespacedSurfaceRuleSource;
...
public class SurfaceRuleManager
{
    ...
    public static SurfaceRules.RuleSource getNamespacedRules(RuleCategory category, SurfaceRules.RuleSource fallback)
    {
        ...
        return new NamespacedSurfaceRuleSource(fallback, builder.build()).base();
    }
