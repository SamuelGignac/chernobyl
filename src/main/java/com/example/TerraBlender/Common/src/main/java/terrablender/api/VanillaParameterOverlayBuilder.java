...
/***
 * This builder is designed for adding {@link Climate.ParameterPoint} to {@link ResourceKey<Biome>} mappings to be layered on top of Vanilla's default mappings.
...
public class VanillaParameterOverlayBuilder
{
    ...
    /**
     * Adds a {@link Climate.ParameterPoint} to {@link ResourceKey<Biome>} mapping.
