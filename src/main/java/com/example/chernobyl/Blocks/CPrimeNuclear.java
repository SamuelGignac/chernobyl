...
public class CPrimeNuclear extends Entity implements TraceableEntity {
    ...
    public CPrimeNuclear(EntityType<?> p_32076_, Level p_32077_) {
        super(p_32076_, p_32077_);
        this.blocksBuilding = true;
    }

    public CPrimeNuclear(Level p_32079_, double p_32080_, double p_32081_, double p_32082_, @Nullable LivingEntity p_32083_) {
