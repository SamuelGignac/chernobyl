...
import com.example.chernobyl.worldgen.placement.CMiscOverworldPlacements;
import com.example.chernobyl.worldgen.placement.CVegetationPlacements;
...
public class COverworldBiomes
{
    ...
    public static Biome auroralGarden(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_AURORAL_GARDEN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_VIOLET);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_ICY_IRIS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome bayou(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_MUD);
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_BAYOU);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_CATTAIL_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_8);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_LARGE_FERN_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILY_PAD_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome bog(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        globalOverworldGeneration(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.LAKES, CMiscOverworldPlacements.LAKE_WATER);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addSwampClayDisk(biomeBuilder);
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        BiomeDefaultFeatures.addCommonBerryBushes(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_BOG);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BUSH_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_4);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
    ...
    public static Biome cloverPatch(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_CLOVER_PATCH);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.CLOVER_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.HUGE_CLOVER);
    ...
    public static Biome coldDesert(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        globalOverworldGeneration(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.LOCAL_MODIFICATIONS, CVegetationPlacements.COLD_DESERT_ROCKS);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.WASTELAND_GRASS_1);
    ...
    public static Biome coniferousForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter, boolean isSnowy)
    {
        ...
        if (isSnowy)
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SNOWY_CONIFEROUS_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SNOWY);
        }
        else
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_CONIFEROUS_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_CONIFEROUS_FOREST);
        }

        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_2);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TOADSTOOL_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome crag(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CMiscOverworldPlacements.CRAG_SPLATTER);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_24);
    ...
    public static Biome deadForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_DEAD_FOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_3);
    ...
    public static Biome dryland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        // Vegetation
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_DRYLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BUSH_1);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
    ...
    public static Biome duneBeach(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_DUNE_GRASS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SEA_OATS);
    ...
    public static Biome field(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter, boolean forest)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        BiomeDefaultFeatures.addRareBerryBushes(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_FIELD_1);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILAC_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.ROSE_BUSH_NORMAL);

        // Vegetation
        if (forest)
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_FIELD_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_15);
        }
        else
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_FIELD);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_FIELD_2);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_10);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SUNFLOWER);
        }
    ...
    public static Biome firClearing(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter, boolean snowy)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        BiomeDefaultFeatures.addRareBerryBushes(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_FIR_CLEARING);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FALLEN_FIR_LOG);
        ...
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_2);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_1);
    ...
    public static Biome floodplain(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        globalOverworldGeneration(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.LAKES, CMiscOverworldPlacements.LAKE_WATER_EXTRA);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_SWAMP);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_RAINFOREST_FLOODPLAIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_RAINFOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILY_PAD_15);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.HUGE_LILY_PAD);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.WATERLILY_FLOWERS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_WATERGRASS_50);
    ...
    public static Biome fungalJungle(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_FUNGAL_JUNGLE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.HUGE_TOADSTOOL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SMALL_TOADSTOOL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TOADSTOOL_EXTRA);

        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.DRIPSTONE_SPLATTER);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.MYCELIUM_SPLATTER);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_5);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_12);
    ...
    public static Biome glowingGrotto(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.GLOWING_GROTTO_VEGETATION);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.GLOWING_GROTTO_MUD);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.GLOWWORM_SILK_STRANDS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.GIANT_GLOWSHROOM_CAVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.HUGE_GLOWSHROOM_CAVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.MEDIUM_GLOWSHROOM_CAVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.SMALL_GLOWSHROOM_CAVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.EXTRA_GLOW_LICHEN);
    ...
    public static Biome grassland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_GRASSLAND);

        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_64);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.HIGH_GRASS);
    ...
    public static Biome highland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        globalOverworldGeneration(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.LOCAL_MODIFICATIONS, CVegetationPlacements.HIGHLAND_ROCKS);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        BiomeDefaultFeatures.addExtraEmeralds(biomeBuilder);
        BiomeDefaultFeatures.addInfestedStone(biomeBuilder);
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_64);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SCATTERED_ROCKS_HIGHLAND);
    ...
    public static Biome jadeCliffs(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addInfestedStone(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_JADE_CLIFFS);
    ...
    public static Biome lavenderField(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter, boolean forest)
    {
        ...
        if (forest)
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_LAVENDER_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_LAVENDER_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_LAVENDER_FOREST);
        }
        else
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_LAVENDER);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_LAVENDER);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_LAVENDER_FIELD);
        }
    ...
    public static Biome lushDesert(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.FLUID_SPRINGS, CMiscOverworldPlacements.SPRING_WATER_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_DEAD_BUSH_2);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_LUSH_DESERT);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_LUSH_DESERT);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_DESERT_GRASS_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_DUNE_GRASS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_1);
    ...
    public static Biome lushSavanna(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.FLUID_SPRINGS, CMiscOverworldPlacements.SPRING_WATER_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_POPPY);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.ROSE_BUSH_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_5);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_24);
    ...
    public static Biome mapleWoods(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter, boolean snowy)
    {
        ...
        if (!snowy)
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_MAPLE_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SNOWY);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_2);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
            return biome(true, 0.25F, 0.5F, spawnBuilder, biomeBuilder, NORMAL_MUSIC);
        ...
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SNOWY_MAPLE_FOREST);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SNOWY);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_2);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_3);
            return biome(true, -0.25F, 0.5F, spawnBuilder, biomeBuilder, NORMAL_MUSIC);
    ...
    public static Biome marsh(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        globalOverworldGeneration(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.LAKES, CMiscOverworldPlacements.LAKE_WATER_MARSH);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_SWAMP);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_250);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_WATERGRASS_250);
    ...
    public static Biome mediterraneanForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_CALCITE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_MEDITERRANEAN_FOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_DEFAULT_EXTENDED_6);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BUSH_1);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PEONY);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_3);
    ...
    public static Biome moor(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_MOOR);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_VIOLET);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SCRUB_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_12);
    ...
    public static Biome muskeg(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_MUD);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_MUSKEG);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SMALL_BROWN_MUSHROOM);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CMiscOverworldPlacements.MUD_SPLATTER);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_1);
    ...
    public static Biome mysticGrove(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, MiscOverworldPlacements.DISK_CLAY);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_WHITE_SAND);
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_MYSTIC_GROVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_MYSTIC_GROVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BLUE_HYDRANGEA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.HUGE_RED_MUSHROOM_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SMALL_RED_MUSHROOM);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.CLOVER_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILAC_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_15);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_WATERGRASS_10);
    ...
    public static Biome oldGrowthDeadForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_OLD_GROWTH_DEAD_FOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
    ...
    public static Biome ominousWoods(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_OMINOUS_WOODS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_OMINOUS_WOODS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_DEAD_GRASS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
    ...
    public static Biome orchard(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_ORCHARD);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_DEFAULT_EXTENDED_15);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.CLOVER_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.ROSE_BUSH_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_5);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome originValley(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        // Biome features
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        biomeBuilder.addCarver(GenerationStep.Carving.AIR, CConfiguredCarvers.ORIGIN_CAVE);
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_ORIGIN_VALLEY);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_ORIGIN_VALLEY);

        return biomeWithColorOverrides(true, 0.6F, 0.6F, 0x0E31FF, 0x070059, 0xB0CFFF, 0x9AFF5F, 0x3AFF00, 0x8CBDFF, spawnBuilder, biomeBuilder, null);
    }
    ...
    public static Biome pasture(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BARLEY);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_64);
    ...
    public static Biome prairie(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_PRAIRIE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_CONIFEROUS_FOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.ROOTED_STUMP);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.GOLDENROD);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_24);
    ...
    public static Biome pumpkinPatch(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SEASONAL_PUMPKIN_PATCH);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.BIG_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PUMPKIN_PATCH);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TOADSTOOL_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_5);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
    ...
    public static Biome rainforest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_ORANGE_SAND);
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_SWAMP);
        BiomeDefaultFeatures.addJungleMelons(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_RAINFOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_RAINFOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.BIG_DRIPLEAF);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_16);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_LARGE_FERN_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILY_PAD_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SMALL_DRIPLEAF);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_WATERGRASS_10);
    ...
    public static Biome rockyRainforest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_RAINFOREST_CLIFFS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_RAINFOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_16);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_LARGE_FERN_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.RAINFOREST_CLIFFS_VINES);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_15);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_24);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_WATERGRASS_10);
    ...
    public static Biome redwoodForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_REDWOOD_FOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_4);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_LARGE_FERN_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.MOSS_SPLATTER);
    ...
    public static Biome rockyShrubland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_ROCKY_SHRUBLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SHRUBLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BUSH_4);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
    ...
    public static Biome scrubland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SCRUBLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SCRUBLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SCRUB_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_DESERT_GRASS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_6);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome shrubland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SHRUBLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SHRUBLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BUSH_4);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILAC_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_10);
    ...
    public static Biome seasonalForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SEASONAL_FOREST);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TOADSTOOL_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_5);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome seasonalOrchard(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultMushrooms(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SEASONAL_ORCHARD);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BARLEY_SPARSE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_4);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_LARGE_FERN_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TOADSTOOL_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_10);
    ...
    public static Biome snowblossomGrove(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_SNOWBLOSSOM_GROVE);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_SNOWBLOSSOM_GROVE);
    ...
    public static Biome spiderNest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        BiomeDefaultFeatures.addPlainVegetation(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.HANGING_COBWEBS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.CORNER_COBWEBS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.WEBBING);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.SPIDER_EGGS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CCavePlacements.STRINGY_COBWEB);
    ...
    public static Biome tropics(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_WHITE_SAND_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        BiomeDefaultFeatures.addJungleMelons(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_TROPICS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_TROPICS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_BLUE_HYDRANGEA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.ROSE_BUSH_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SHORT_BAMBOO);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome tundra(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, CMiscOverworldPlacements.DISK_GRAVEL_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_TUNDRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_2);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_5);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TUNDRA_SHRUBS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.SCATTERED_ROCKS);
    ...
    public static Biome volcano(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        BiomeGenerationSettings.Builder biomeBuilder = new BiomeGenerationSettings.Builder(placedFeatureGetter, carverGetter);
        globalOverworldGeneration(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.LAKES, CMiscOverworldPlacements.LAKE_LAVA_SURFACE_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.FLUID_SPRINGS, CMiscOverworldPlacements.SPRING_LAVA_VOLCANO);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.UNDERGROUND_ORES, MiscOverworldPlacements.DISK_GRAVEL);
        BiomeDefaultFeatures.addExtraEmeralds(biomeBuilder);
        BiomeDefaultFeatures.addInfestedStone(biomeBuilder);
    ...
    public static Biome volcanicPlains(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.FLUID_SPRINGS, CMiscOverworldPlacements.SPRING_LAVA_VOLCANO);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_VOLCANIC_PLAINS);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CMiscOverworldPlacements.MOSSY_BLACK_SAND_SPLATTER);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_SPROUTS_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
    ...
    public static Biome wasteland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_WASTELAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_WASTELAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.WASTELAND_GRASS_2);
    ...
    public static Biome wetland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_SWAMP);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_WETLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_WETLAND);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_CATTAIL_EXTRA);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_FERN_8);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.LILY_PAD_10);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TOADSTOOL_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_REED_5);
    ...
    public static Biome woodland(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter, boolean dense)
    {
        ...
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FLOWER_DEFAULT_EXTENDED_6);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.ROSE_BUSH_NORMAL);
        addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.FALLEN_LOG);

        if (dense)
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_DENSE_WOODLAND);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_12);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_12);
        }
        else
        {
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_GRASS_6);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.PATCH_TALL_GRASS_6);
            addFeature(biomeBuilder, GenerationStep.Decoration.VEGETAL_DECORATION, CVegetationPlacements.TREES_WOODLAND);
        }
