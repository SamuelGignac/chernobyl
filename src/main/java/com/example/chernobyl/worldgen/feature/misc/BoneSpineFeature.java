...
public class BoneSpineFeature extends Feature<NoneFeatureConfiguration>
{
    ...
    protected SimpleBlockPredicate replace = (world, pos) -> this.isAir(world, pos) || TreeFeature.isAirOrLeaves(world, pos) || world.getBlockState(pos).liquid() || world.getBlockState(pos).getBlock() == CBlocks.RANDOM_BLOCK.get() || world.getBlockState(pos).getBlock() == CBlocks.RANDOM_BLOCK.get();
