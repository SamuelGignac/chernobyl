...
public class HugeCloverFeature extends Feature<NoneFeatureConfiguration>
{
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> featurePlaceContext)
    {
        ...
        this.setBlock(world, pos, CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HorizontalDirectionalBlock.FACING, Direction.NORTH));
        this.setBlock(world, pos.south(), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HorizontalDirectionalBlock.FACING, Direction.WEST));
        this.setBlock(world, pos.east(), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HorizontalDirectionalBlock.FACING, Direction.EAST));
        this.setBlock(world, pos.south().east(), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HorizontalDirectionalBlock.FACING, Direction.SOUTH));
