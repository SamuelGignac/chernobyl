    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> featurePlaceContext)
    {
        ...
        for (int x = -(radius-1); x <= (radius-1); x++)
        {
            for (int z = -(radius-1); z <= (radius-1); z++)
            {
                ...
                this.setBlock(world, pos.offset(x, height+1, z), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
                this.setBlock(world, pos.offset(x, height+2, z), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
            }
        }

        this.setBlock(world, pos.offset(0, height+3, 0), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
        this.setBlock(world, pos.offset(1, height+3, 0), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
        this.setBlock(world, pos.offset(-1, height+3, 0), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
        this.setBlock(world, pos.offset(0, height+3, 1), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
        this.setBlock(world, pos.offset(0, height+3, -1), CBlocks.RANDOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, false));
