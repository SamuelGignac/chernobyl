...
public class CSurfaceRuleData
{
    ...
    // Chernobyl
    private static final SurfaceRules.RuleSource PLUTONIUM_ORE = makeStateRule(CBlocks.PLUTONIUM_ORE.get());
    private static final SurfaceRules.RuleSource URANIUM_ORE = makeStateRule(CBlocks.URANIUM_ORE.get());
    ...
    public static SurfaceRules.RuleSource overworldLike(boolean checkAbovePreliminarySurface, boolean p_198382_, boolean p_198383_) {
        ...
        SurfaceRules.ConditionSource isSandstoneLiningBiome = SurfaceRules.isBiome(Biomes.WARM_OCEAN, Biomes.DESERT, Biomes.BEACH, Biomes.SNOWY_BEACH, CBiomes.RADIOACTIVE);
    ...
    private static SurfaceRules.RuleSource makeCRules()
    {
        return SurfaceRules.sequence(
//                TODO: Add surface rules for Chernobyl
        );
    }
