...
import com.example.chernobyl.item.custom.GeigerCounterItem;
...
public class ModItems {
    ...
    private static void registerItems() {
        ...
        GEIGER_COUNTER = registerItem(() -> new GeigerCounterItem(new Item.Properties().stacksTo(5)), "geiger_counter");
    }
